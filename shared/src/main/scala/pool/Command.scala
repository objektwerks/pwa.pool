...
final case class SignUp(emailAddress: String, pin: Int) extends Command

final case class ActivateLicensee(license: String, emailAddress: String, pin: Int) extends Command
